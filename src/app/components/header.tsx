  ...
  return (
    ...
    <div className="bg-[#F5F5F5] flex justify-between items-center px-6 py-2 md:text-[11px] sm:text-[9px] text-[8px] font-medium text-gray-500">
      ...
      <div className="flex md:gap-4 sm:gap-3 gap-2">
        <Link href="#" className="hover:text-gray-600">Find Link Store</Link>
    ...
    <div className="flex flex-wrap justify-between items-center px-6 py-4">
      ...
      <nav className="flex gap-4 md:gap-6 text-gray-600 font-medium md:text-[16px] sm:text-[14px] text-[10px] ">
      ...
      <div className="flex items-center gap-4 mt-4 md:mt-0">
        ...
        <div className="relative hidden md:block">
          <input
            type="text"
            placeholder="Search"
            className="border border-gray-600 rounded-full pl-4 pr-10 py-2 text-sm focus:outline-none"
          />
          <FaSearch className="absolute right-3 top-2.5 text-gray-600" />
        </div>
        <FaRegHeart className="text-gray-800 md:w-[24px] md:h-[24px] sm:w-[20px] sm:h-[20px] w-[16px] h-[16px]  cursor-pointer hover:text-black" />
        <BiShoppingBag  className="text-gray-800 md:w-[24px] md:h-[24px] sm:w-[20px] sm:h-[20px] w-[16px] h-[16px] cursor-pointer hover:text-black" />
      </div>
    </div>
    ...
    <div className="block md:hidden px-6 mt-2">
      <div className="relative">
        <input
          type="text"
          placeholder="Search"
          className="border border-gray-400 rounded-full pl-4 pr-10 py-2 text-sm focus:outline-none w-full"
        />
