...
export default function footer() {
  ...
  <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
    ...
    <div className="flex justify-start lg:justify-end items-start gap-4">
      <FaTwitter className="text-lg cursor-pointer hover:text-gray-500" />
      <FaFacebook className="text-lg cursor-pointer hover:text-gray-500" />
      <FaYoutube className="text-lg cursor-pointer hover:text-gray-500" />
      <FaInstagram className="text-lg cursor-pointer hover:text-gray-500" />
    </div>
  </div>

  {/* Bottom Section */}
  <div className="mt-8 flex flex-wrap justify-between items-center text-xs text-gray-500">
